...
const EmployeeList = () => {
    ...
    const handleDelete = (id) => {
        ...
        const filteremployee = employeelist.filter((item)=>item._id != id );
       var config = {
        method: 'delete',
    ...
    return(
        ...
        <Layout>
            ...
            <div className="m-3">
             <div className="flex mb-3" ><h4 className="text-gray-400">Employee</h4> <span className="ms-2 text-gray-400">Employee List</span></div>
             <div className="flex bg-gray-500 p-3 text-gray-700 mb-3"> 
             <span className="mt-1 ms-1"><GoHomeFill/></span>   
             <span className="me-1">Home</span> {">"} <span className="ms-1">Employee  {">"} Employee list</span></div>
             <div>
             <div className="flex mb-3">
             <button type="button" onClick={()=>handleOpenModal()}  className="bg-green-500 text-white ps-2 pe-2 pt-1 pb-1">Add New Employee</button></div>
             </div>
             <div className="mt-3">
             {employeelist.length>0 ?
                <SharedTable handleDelete={handleDelete} data={employeelist} usedrole ="employee" handleEditadmindetails={handleEditadmindetails}/>
              :
              <div className="text-center">No Record Found</div>
                ...
                {showModal &&
                <Modal
                  modalTitle={`${modalTitle} Employee`}
